...
export default function SpendingInsights({ predictions }) {
  ...
  const totalForecast = predictions?.projections
    ? Object.values(predictions.projections).reduce(
        ...
        <Table aria-label="spending insights table">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="right">
                <strong>Forecasted Amount</strong>
              </TableCell>
              <TableCell align="right">
          ...
          <TableBody>
            {predictions.projections &&
              Object.entries(predictions.projections).map(
                ([category, amount]) => (
                    ...
                    >
                      ...
                      >
                        <div className="emoji-container no-underline">
                          <span>{getEmojiForCategory(category)}</span>
                        </div>
                        <span>{category}</span>
                      </div>
                    </TableCell>
            ...
            <TableRow>
              <TableCell>
                <strong>Total Forecasted Spending</strong>
              </TableCell>
              <TableCell align="right" sx={{ fontSize: "1rem" }}>
